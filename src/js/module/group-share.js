/*!
 * @author liyuelong1020@gmail.com,lixiaoxiao
 * @date 20170522
 * @version 2.0.0
 * @description 拼团专用分享插件
 *
 * 支持平台：微信/QQ/QQ浏览器/UC浏览器
 *
 * 使用方法： shareObject = Share(config);
 * shareObject.show();展开弹窗
 * shareObject.hide();关闭弹窗
 * shareObject.config(config);重新配置分享参数
 *
 *  // 分享配置参数
 * @config [object]
 * {
...
define('group-share', ['weixin', 'popup', "base64", 'qrcode'], function (require, exports) {
...
//          is_code_share = false;
        ...
        var createPopup = function () {
            ...
            var shtml = '<div class="share-tips">' +
	            '<div class="share-tips-img"></div>' +
	            '<p>您已参团</p>' +
	            '<p>还差<span>'+share.config.join_left+'</span>位小伙伴就能拼团成功啦，<br/>快邀请小伙伴一起参团吧！</p>'+
	        	'</div>' +
            	'<div class="popup-content-share">';
            	if(platform.isFromBYTouchMachine){
            		shtml += '<div class="hide share-list" id="share-list">' +
	                '<ul>' +
	                ...
	                '</ul>' +
	                '</div>' +
	                '<div class="share-code" id="share-qrcode">' +
	                '<div class="share-code-pic" id="qrcode"></div>' +
	                '</div>';
            	}else{
            		shtml += '<div class="share-list" id="share-list">' +
	                '<ul>' +
	                '<li><a href="javascript:;" id="share-wf"><i class="icon icon-share-wf"></i><span>微信好友</span></a></li>' +
	                '<li><a href="javascript:;" id="share-wp"><i class="icon icon-share-wp"></i><span>朋友圈</span></a></li>' +
	                '<li><a href="javascript:;" id="share-qf"><i class="icon icon-share-qf"></i><span>QQ好友</span></a></li>' +
                ...
                shtml += '<a class="close-cancel-btn" href="javascript:;" id="cancel-btn">取消</a>' +
                '</div>' +
...
//          });
		    ...
		    dialog.addEventListener('click', function(e) {
		        if(!share_list.isEqualNode(e.target) && !share_list.contains(e.target)){
		        	if(e.target.id && e.target.id == 'cancel-btn'){
		        		if(is_code_share){
		        			is_code_share = false;
